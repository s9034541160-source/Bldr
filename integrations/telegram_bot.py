...
# Control default context search behavior for Telegram text messages
...
async def handle_text(update, context):
    ...
    try:
        ...
        # Heuristic: enable context search only for queries that look like norms search
        ...
        # Use AI chat endpoint; disable context by default for plain chit-chat
        chat_payload = {
            'message': text,
        ...
        if do_tts:
            try:
                ...
                if tts_resp.status_code == 200:
                    ...
                    if audio_file.status_code == 200 and hasattr(application, 'bot'):
