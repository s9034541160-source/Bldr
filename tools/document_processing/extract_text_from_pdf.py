...
coordinator_interface = ToolInterface(
    purpose="Извлечение текста из PDF документов",
    input_requirements={
    ...
    usage_guidelines={
        "for_coordinator": [
            "Используйте для извлечение текста из pdf документов",
...
manifest = ToolManifest(
    ...
    enabled=True,
    system=False,
    entrypoint="tools.document_processing.extract_text_from_pdf:execute",
    params=[
        ToolParam(
            name="param1",
            type=ToolParamType.STRING,
    ...
    tags=["document_processing", "enterprise"],
    result_display={
        "type": "text",
...
def execute(**kwargs) -> Dict[str, Any]:
    """Execute extract_text_from_pdf with enterprise-level features."""
    ...
    try:
        ...
        return {
            ...
            'result_type': 'text',
            'result_title': f'🔧 Результат extract_text_from_pdf',
