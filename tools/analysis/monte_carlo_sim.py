...
coordinator_interface = ToolInterface(
    purpose="Монте-Карло симуляция для анализа рисков проекта",
    input_requirements={
    ...
    usage_guidelines={
        "for_coordinator": [
            "Используйте для монте-карло симуляция для анализа рисков проекта",
...
manifest = ToolManifest(
    ...
    enabled=True,
    system=False,
    entrypoint="tools.analysis.monte_carlo_sim:execute",
    params=[
        ToolParam(
            name="param1",
            type=ToolParamType.STRING,
...
def execute(**kwargs) -> Dict[str, Any]:
    """Execute monte_carlo_sim with enterprise-level features."""
    ...
    try:
        ...
        return {
            ...
            'result_type': 'text',
            'result_title': f'🔧 Результат monte_carlo_sim',
