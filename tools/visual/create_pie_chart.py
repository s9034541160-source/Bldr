...
coordinator_interface = ToolInterface(
    purpose="Создание круговых диаграмм для визуализации данных",
    input_requirements={
    ...
    usage_guidelines={
        "for_coordinator": [
            "Используйте для создание круговых диаграмм для визуализации данных",
...
manifest = ToolManifest(
    ...
    enabled=True,
    system=False,
    entrypoint="tools.visual.create_pie_chart:execute",
    params=[
        ToolParam(
            name="param1",
            type=ToolParamType.STRING,
...
def execute(**kwargs) -> Dict[str, Any]:
    """Execute create_pie_chart with enterprise-level features."""
    ...
    try:
        ...
        return {
            ...
            'result_type': 'text',
            'result_title': f'🔧 Результат create_pie_chart',
