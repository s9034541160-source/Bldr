...
coordinator_interface = ToolInterface(
    purpose="Создание диаграммы Ганта для планирования проекта",
    input_requirements={
    ...
    usage_guidelines={
        "for_coordinator": [
            "Используйте для создание диаграммы ганта для планирования проекта",
...
manifest = ToolManifest(
    ...
    enabled=True,
    system=False,
    entrypoint="tools.project_management.create_gantt_chart:execute",
    params=[
        ToolParam(
            name="param1",
            type=ToolParamType.STRING,
    ...
    tags=["project_management", "enterprise"],
    result_display={
        "type": "text",
...
def execute(**kwargs) -> Dict[str, Any]:
    """Execute create_gantt_chart with enterprise-level features."""
    ...
    try:
        ...
        return {
            ...
            'result_type': 'text',
            'result_title': f'🔧 Результат create_gantt_chart',
