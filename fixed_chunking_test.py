#!/usr/bin/env python3
"""
Исправленный тест рекурсивного ГОСТ-чанкинга с правильными паттернами
"""
import re
...
def recursive_gost_chunking(content: str, metadata: Dict) -> List[DocumentChunk]:
    ...
    try:
        ...
        # Более гибкие паттерны, которые учитывают русский текст
...
7.1.1 Контроль должен проводиться в соответствии с требованиями
    ...
    print("=== ИСПРАВЛЕННЫЙ ТЕСТ РЕКУРСИВНОГО ГОСТ-ЧАНКИНГА ===")
