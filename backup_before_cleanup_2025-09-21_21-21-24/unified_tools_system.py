...
class UnifiedToolsSystem:
    ...
    def _execute_legacy_tool(self, tool_name: str, **kwargs) -> Any:
        ...
        # Special handling for TTS tool
        if tool_name == "text_to_speech":
            return self._execute_tts_tool(**kwargs)
    ...
    def _execute_tts_tool(self, **kwargs) -> Dict[str, Any]:
        """Execute TTS tool by calling the backend API"""
        import requests
        import os
        ...
        try:
            ...
            response = requests.post(tts_endpoint, json=kwargs)
