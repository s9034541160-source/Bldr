#!/usr/bin/env python3
"""
Test script for system components
"""
...
def main():
    print("Starting system components test...")
    ...
    result = cm.start_component('celery_beat')
    print(f"Celery Beat started: {result}")
    print(f"Celery Beat status: {cm.components['celery_beat'].status.value}")
    time.sleep(5)  # Ждем запуска Celery Beat
