#!/usr/bin/env python3
"""
Рабочий тест рекурсивного ГОСТ-чанкинга с исправленными паттернами
"""
import re
...
def recursive_gost_chunking(content: str, metadata: Dict) -> List[DocumentChunk]:
    ...
    try:
        ...
        # Более простые и надежные паттерны
...
def test_working_chunking():
    """Рабочий тест чанкинга"""
...
7.1.1 Контроль должен проводиться в соответствии с требованиями
    ...
    print("=== РАБОЧИЙ ТЕСТ РЕКУРСИВНОГО ГОСТ-ЧАНКИНГА ===")
